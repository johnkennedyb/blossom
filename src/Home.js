...
const Home = () => {
    return (
        <div className="container-fluid p-0 mb-5">
            <div className="row">
                <div className="col-md-12-lg-6 position-relative bg-dark text-white py-5" style={{backgroundImage: `url('https://images.pexels.com/photos/7356/startup-photos-7356.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')`, backgroundSize: 'cover', backgroundPosition: 'center' ,zIndex: 1,  height: 550}}>
                    ...
                    <div className="text-left py-5 px-5 " >
                        ...
                        <p className="lead ">Our commitment to excellence, where we dedicate ourselves entirely to delivering top-notch products and services,<br /> while only asking for a fraction of the benefits in return.</p>
            ...
            <div className="row mx-auto   mx-5 px-5 mb-5 justify-content-center" style={{ position: 'relative', zIndex: 2 , marginTop:"-70px"}}>
                <div className="col-md-4 pt-2 pb-2 mb-4">
                    <div className="position-relative p-5 bg-white border rounded text-dark py-3 d-flex flex-column align-items-center justify-content-center" style={{ transition: 'transform 0.3s ease-in-out' }} onMouseOver={(e) => e.currentTarget.style.transform = 'scale(1.1)'} onMouseOut={(e) => e.currentTarget.style.transform = 'scale(1)'}>
                        <FaUser size={30} />
                        <h4 className='pt-2'>FINANCE MANAGEMENT</h4>
                        <p className='' >We understand that owning a business is not just about transactions; it's about realizing a dream. Our dedicated team is here to guide and support you at every step of your entrepreneurial venture. </p>
                    </div>
                </div>
                <div className="col-md-4  pt-2 pb-2 mb-4">
                    <div className="position-relative p-5 bg-white border rounded text-dark py-3 d-flex flex-column align-items-center justify-content-center" style={{ transition: 'transform 0.3s ease-in-out' }} onMouseOver={(e) => e.currentTarget.style.transform = 'scale(1.1)'} onMouseOut={(e) => e.currentTarget.style.transform = 'scale(1)'}>
                        ...
                        <p>As your trusted partner,we are dedicated to understanding your unique financial aspirations and crafting personalized strategies to help you achieve them.</p>
                    </div>
                </div>
                <div className="col-md-4  pt-2 pb-2 mb-4">
                    <div className="position-relative p-5 bg-white border rounded text-dark py-3 d-flex flex-column align-items-center justify-content-center " style={{ transition: 'transform 0.3s ease-in-out' }} onMouseOver={(e) => e.currentTarget.style.transform = 'scale(1.1)'} onMouseOut={(e) => e.currentTarget.style.transform = 'scale(1)'}>
                        <FaToolbox size={30} />
                        <h4  className='pt-2'>Employments</h4>
                        <p>Are you ready to embark on a rewarding career journey filled with growth, innovation, and endless possibilities? Look no further than [Company Name] organization.</p>
                    </div>
                </div>
                
            </div>
            <div class=" text-white py-5 bg-purple" style={{ backgroundColor: "#1a0dad" }}>
    <div class="container">
...
<div className="text-white py-5 bg-purple" style={{ background: "linear-gradient(to bottom, #1a0dad, white)" }}>
